...
if v:version < 703
command! -bar -range -nargs=*                  SyntaxInclude call SyntaxRange#SyntaxInclude(<line1>, <line2>, <q-args>)
else
command! -bar -range -nargs=* -complete=syntax SyntaxInclude call SyntaxRange#SyntaxInclude(<line1>, <line2>, <q-args>)
endif
